...
class CurrentResponse {
  ...
  factory CurrentResponse.fromJson(String str) =>
      CurrentResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CurrentResponse.fromMap(Map<String, dynamic> json) => CurrentResponse(
